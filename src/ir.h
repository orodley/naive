...
#define IR_OPS                                                               \
  X(OP_INVALID), X(OP_BIT_XOR), X(OP_BIT_OR), X(OP_BIT_AND), X(OP_BIT_NOT),  \
      ...
      X(OP_ZEXT), X(OP_SEXT), X(OP_TRUNC), X(OP_SINT_TO_FLOAT), X(OP_FIELD), \
      X(OP_LOAD), X(OP_STORE), X(OP_LOCAL), X(OP_RET), X(OP_RET_VOID),       \
      X(OP_JUMP), X(OP_COND), X(OP_PHI), X(OP_BUILTIN_VA_START),             \
      X(OP_BUILTIN_VA_ARG),
