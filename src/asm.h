...
#define ASM_OPS                                                                \
  X(NOP), X(MOV), X(MOVSX), X(MOVZX), X(MOVSS), X(MOVSD), X(RET), X(CALL),     \
      ...
      X(PUSH), X(POP), X(IMUL), X(IDIV), X(CDQ), X(CQO), X(CMP), X(SETE),      \
      X(SETNE), X(SETG), X(SETGE), X(SETL), X(SETLE), X(SETA), X(SETAE),       \
      X(SETB), X(SETBE), X(TEST), X(JMP), X(JE), X(JNE), X(JG), X(JGE), X(JL), \
      X(JLE), X(JA), X(JAE), X(JB), X(JBE), X(ADC), X(SBB), X(SYSCALL),
